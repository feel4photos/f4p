...
function twentyfourteen_setup() {
	...
	register_nav_menus( array(
		'f4pMainmenu'   => __( 'f4p Main Menu', 'twentyfourteen' ),
...
//register_taxonomy( 'our_services', 'ourservicervices', $taxoArgs );
...
'not_found' => __('No Team member have been added yet'),
...
'show_in_menu' => true,
'show_in_nav_menus' => false,
'rewrite' => array( 'slug' => 'f4pteam' ),
'supports' => array('title', 'editor', 'thumbnail', 'author', 'excerpt'),
'has_archive' => true,
);

register_post_type( 'f4pteam' , $args );
